...
* country with Highest Banana yield: XXX
* country with Highest Bean yield: XXX
* Country with 'low' yields for many of the selected crops: XXX   (this response may be non-unique)
```
